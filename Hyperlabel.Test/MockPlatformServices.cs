...
{
	internal class MockPlatformServices : Xamarin.Forms.Internals.IPlatformServices
	{
		...
		public class MockIsolatedStorageFile : Xamarin.Forms.Internals.IIsolatedStorageFile
		{
    ...
    string Xamarin.Forms.Internals.IPlatformServices.GetMD5Hash(string input) => GetHash(input);

		public OSAppTheme RequestedTheme { get; set; }
	}

	internal class MockDeserializer : Xamarin.Forms.Internals.IDeserializer
	{
	...
	internal class MockResourcesProvider : Xamarin.Forms.Internals.ISystemResourcesProvider
	{
